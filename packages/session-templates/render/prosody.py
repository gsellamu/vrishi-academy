...
STAGE_MAP = {
    ...
    "stage_auto_dual":      (3, "induction",     "authority",      None),
    ...
    "stage_guided_imagery": (4, "deepening",     "theta_hypnotic", None),
    ...
    "stage_self_hypnosis_teach": (9, "post_session", "conversational", None),
